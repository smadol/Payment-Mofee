<?php if (!defined('THINK_PATH')) exit(); /*a:3:{s:82:"D:\phpStudy\PHPTutorial\WWW\mofee\public/../data/template/index/index\scanPay.html";i:1521307788;s:78:"D:\phpStudy\PHPTutorial\WWW\mofee\data\template\index\common\product-head.html";i:1521339463;s:76:"D:\phpStudy\PHPTutorial\WWW\mofee\data\template\index\common\index-foot.html";i:1521339555;}*/ ?>
        <!DOCTYPE html>
...
<div ui-view="" class="outer-content ng-scope" id="main_content" style="">
    <div class="container-fluid padding-none pay-box-wrap ng-scope">
        ...
        <div class="container">
            <div class="product-type product-type-white product-type8">
                <h3 class="clearfix"><i class="pull-left"></i><span class="pull-left">扫码支付</span></h3>
                <div class="product-type-txt">
                    <p>用户通过选择自己喜欢的支付方式扫码完成支付，</p>
                    <p>支付方式的定向选择，用户的方便就是您的方便。</p>
                </div>
            </div>
            <img src="/static/ipay/images/banner-right6.png" class="pay-top-right user-pay-top-right">
        </div>
        </div>
        <div class="bgf">
            <div class="container">
                <div class="row">
                    ...
                    <div class="joinmode-item col-md-12 text-center">
                        ...
                        <div class="fifth-contet-btn">
                            <a target="_blank" class="btn btn-black btn-red" ui-sref="userScan" ng-btn-hover="" href="/support/doc">查看API文档</a>
