<?php if (!defined('THINK_PATH')) exit(); /*a:1:{s:84:"D:\phpStudy\PHPTutorial\WWW\mofee\public/../data/template/index/docment\scanPay.html";i:1521302359;}*/ ?>
<!DOCTYPE html>
...
<div ui-view="" class="outer-content ng-scope" id="main_content" style="">
    ...
    <!-- uiView: developerTopMenu -->
        <div ui-view="developerTopMenu" class="ng-scope">
            <link rel="stylesheet" href="/static/ipay/css/doc.css" class="ng-scope">
    ...
    <script class="ng-scope">
        ...
        <div class="container container-style">
            <div class="doc-main-wrapper">
                <doc-side-bar hide-menu="using_scenes,product_join,mch_N002,output_type" doctitle="用户扫码" class="ng-isolate-scope"><!--<link rel="stylesheet" href="css/develop/doc.css">-->
                    <div class="doc-sidebar-wrapper" style="position: absolute;">
                        <p class="drop-down display-none doc-top-menu doc_top_menu up ng-binding">用户扫码</p>
                            ...
                            <ul class="menu-group">
                                ...
                                <li class="menu-item">
                                    ...
                                    <ol>
                                        ...
                                        <li style="display: none;"><a id="mch_N002">· N002-前端支付结果通知</a></li>
                                    </ol>
                                </li>
                                <li class="menu-item">
                                ...
                                <li class="menu-item">
                                    ...
                                    <ol>
                                        ...
                                        <li><a id="mch_domain">· 商户保留域说明</a></li>
                ...
                <div class="doc-main-container">
                    ...
                    <div class="doc-common-content product_usage">
                        ...
                        <div class="doc-content-container">
                            ...
                            <div class="doc-common-frame">
                                <img ng-img-max="" src="image/front/doc/doc-mch1.png" class="viewer-toggle">
                            </div>
                            <p class="clear-both">②用户使用手机支付宝扫一扫功能扫码支付</p>
                            <div class="doc-common-frame">
                                <img ng-img-max="" src="image/front/doc/doc-mch2.png" class="viewer-toggle">
                            </div>
                            <div class="doc-common-frame">
                                <img ng-img-max="" src="image/front/doc/doc-mch3.png" class="viewer-toggle">
                            </div>
                            <p class="font-weight clear-both">（2）微信支付</p>
                            <p>①商户对接扫码支付接口，通过传递下单参数生成微信支付二维码或二维码链接（二维码链接商户可自行生成二维码）</p>
                            <div class="doc-common-frame">
                                <img ng-img-max="" src="image/front/doc/doc-mch4.png" class="viewer-toggle">
                            </div>
                            <p class="clear-both">②使用手机微信扫一扫功能扫码支付</p>
                            <div class="doc-common-frame">
                                <img ng-img-max="" src="image/front/doc/doc-mch5.png" class="viewer-toggle">
                            </div>
                            <div class="doc-common-frame">
                                <img ng-img-max="" src="image/front/doc/doc-mch6.png" class="viewer-toggle">
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="doc-common-content juhe_WP001">
                        <p class="doc-content-title">WP001-主扫聚合支付</p>
                        <div class="doc-content-container">
                            ...
                            <table class="table table-hover">
                                ...
                                <tr>
                                    ...
                                    <td>
                                        ...
                                        <span class="display-block">13 微信支付</span>
                                    </td>
                                </tr>
                                <tr>
                                    <td>商户保留域</td>
                        ...
                        <div class="doc-content-container">
                            ...
                            <table class="table table-hover">
                                ...
                                <tr>
                                    ...
                                    <td>String(0,40)</td>
                                    <td>N</td>
                                    <td>当微信支付时，有sub_openid则返回，否则不返回<br>
                                        当支付宝支付时，有buyer_id则返回，否则不返回</td>
                                </tr>
                                <tr>
                                    <td>支付成功时间</td>
                                    <td>payTime</td>
                        ...
                        <div class="doc-content-container">
                            ...
                            <table class="table table-hover">
                                ...
                                <tr>
                                    ...
                                    <td>String(0,40)</td>
                                    <td>N</td>
                                    <td>当微信支付时，当有sub_openid则返回，否则不返回<br>
                                        当支付宝支付时，当有buyer_id则返回，否则不返回 </td>
                                </tr>
                                <tr>
                                    <td>商户保留域</td>
                                    <td>mhtReserved</td>
...
<pre><code class="java">
    ...
    String reportContent = reportBuilder.toString();
                    ...
                    <div class="doc-common-content mch_domain">
                        <p class="doc-content-title">商户保留域说明</p>
                        <div class="doc-content-container">
                            <p>平台类商户在使用微信支付时，需要上送mchBankId字段，值为在现在支付备案的子商户编号；
                                格式：mchBankId=123&amp;商户保留域参数
                            </p>
                        </div>
                    </div>
    ...
    <div class="container">
        <div class="footer-content clearfix">
            <div>
                ...
                <span class="footer-content-content"><a onclick="jump(this)" href="javascript:void(0)" data="http://www.ipaynow.cn/html/us/withUsComp.html">公司介绍</a><br></span>
                <span class="footer-content-content"><a onclick="jump(this)" href="javascript:void(0)" data="http://www.ipaynow.cn/html/us/withUsTeam.html">团队介绍</a><br></span>
                <span class="footer-content-content"><a onclick="jump(this)" href="javascript:void(0)" data="http://www.ipaynow.cn/html/us/withUsNews.html">新闻动态</a><br></span>
                <span class="footer-content-content"><a onclick="jump(this)" href="javascript:void(0)" data="http://www.ipaynow.cn/html/us/withUsJoinUs.html">招聘信息</a><br></span>
            </div>
            <div>
                <p>
                    <span class="footer-content-title">产品<br></span>
                    <span class="footer-content-content"><a target="_blank" ui-sref="appPay" href="/appPay">手机App支付</a><br></span>
                    <span class="footer-content-content"><a target="_blank" ui-sref="phonePay" href="/phonePay">手机网页支付</a><br></span>
                    <span class="footer-content-content"><a target="_blank" ui-sref="pcPay" href="/pcPay">PC网页支付</a><br></span>
                    <span class="footer-content-content"><a target="_blank" ui-sref="officialPay" href="/officialPay">公众号支付</a><br></span>
                    <span class="footer-content-content"><a target="_blank" ui-sref="scanPay" href="/scanPay">商家扫码</a><br></span>
                    <span class="footer-content-content"><a target="_blank" ui-sref="userScanPay" href="/userScanPay">用户扫码</a><br></span>
                    <span class="footer-content-content"><a target="_blank" ui-sref="cardPay" href="/cardPay">卡牌支付</a><br></span>
                    <span class="footer-content-content"><a target="_blank" ui-sref="capacityPosPay" href="/capacityPosPay">智能POS</a><br></span>
                </p>
                <p class="footer-product2">
                    <span class="footer-content-content"><a target="_blank" ui-sref="auth" href="/auth">鉴权服务</a><br></span>
                    <span class="footer-content-content"><a target="_blank" ui-sref="noteServe" href="/noteServe">短信服务</a><br></span>
                    <span class="footer-line-between"></span>
                    <span class="footer-content-content"><a target="_blank" ui-sref="bankCollaborate" href="/bankCollaborate">银行合作</a><br></span>
                    <span class="footer-content-content"><a target="_blank" ui-sref="account" href="/account">二类账户</a><br></span>
                    <span class="footer-content-content"><a target="_blank" ui-sref="crossPay" href="/crossPay">跨境支付</a><br></span>
                </p>


            </div>
            <div>
                <span class="footer-content-title">其他服务<br></span>
                <span class="footer-content-content"><a target="_blank" href="https://www.18join.com/">金融服务</a><br></span>
                <span class="footer-content-content"><a target="_blank" href="http://www.wboll.com/">互联网营销</a><br></span>
                <span class="footer-content-content"><a target="_blank" href="http://www.bjyzwl.cn/">云服务</a><br></span>
            </div>
            <div>
                <span class="footer-content-title">开发者中心<br></span>
                <!--<span class="footer-content-content"><a href="#">帮助问答</a></br></span>-->
                <span class="footer-content-content"><a target="_blank" ui-sref="userScan" href="/userScan">API文档</a><br></span>
                <span class="footer-content-content"><a target="_blank" ui-sref="sdkDownload" href="/sdkDownload">SDK下载</a><br></span>
                <!--<span class="footer-content-content"><a ui-sref="demoExperience">Demo体验下载</a></br></span>-->

            </div>

            <div>
                <span class="footer-content-title">帮助<br></span>
                <span class="footer-content-content"><a onclick="jump(this)" href="javascript:void(0)" data="http://www.ipaynow.cn/html/help/helpComm.html">常见问题</a><br></span>
                <span class="footer-content-content"><a onclick="jump(this)" href="javascript:void(0)" data="http://www.ipaynow.cn/html/help/helpTech.html">技术问题</a><br></span>
            </div>
            <div>
                <span class="footer-content-title">咨询方式<br></span>
                <span class="footer-content-content">邮箱：<a href="mailto:ipaynow@ipaynow.cn">iPaynow@iPaynow.cn</a><br></span>
                <span class="footer-content-content">电话：4006-365-303<br></span>
                <span class="footerContact footerWay1">
        ...
        <div class="footer-ICP">
            <span class=" h6">iPaynow&nbsp;2017&nbsp;京ICP备13029197号</span>
        </div>
...
<back-to-top id="backtotop" class=""><div class="bttbg"></div></back-to-top>
<!--未登录时的主导航-->
<!--<script src="/static/ipay/js/controller/topMenu.js?v=1392464704"></script>-->
<!--主导航-->
<script src="/static/ipay/js/mainMenu.js?v=d3dce8277f"></script>
<script src="/static/ipay/js/index.js?v=4a6b945464"></script>
