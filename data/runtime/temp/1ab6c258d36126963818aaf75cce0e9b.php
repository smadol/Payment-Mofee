<?php if (!defined('THINK_PATH')) exit(); /*a:3:{s:82:"D:\phpStudy\PHPTutorial\WWW\payment\public/../data/template/index/index\index.html";i:1521288222;s:78:"D:\phpStudy\PHPTutorial\WWW\payment\data\template\index\common\index-head.html";i:1521289738;s:78:"D:\phpStudy\PHPTutorial\WWW\payment\data\template\index\common\index-foot.html";i:1521290873;}*/ ?>
    ...
    <div class="header-menu col-lg-8 col-md-12 col-lg-offset-2">
        ...
        <div class="header-menu-links">
                ...
                <div class="menu-product-content menu-hidd">
                    <div class="menu-product-list menu-list">
                        <dl class="develop-center-menu">
                            <dt>支付服务</dt>
                            <dt><a target="_blank" href="/phonePay">手机网页支付</a></dt>
                            <dt><a target="_blank" href="/pcPay">PC网页支付</a></dt>
                            <!--<dt><a target="_blank" href="/officialPay">公众号支付</a></dt>-->
                            <dt><a target="_blank" href="/scanPay">扫码支付</a></dt>
                            <dt><a target="_blank" href="/cardPay">卡牌支付</a></dt>
                        </dl>
                    </div>
                </div>
            </div>
            ...
            <div class="menu-exploit">
                ...
                <div class="menu-exploit-content menu-hidd">
                    <div class="menu-exploit-list menu-list">
                        <dl class="">
                            <dt><a target="_blank"  href="/userScan">API文档</a></dt>
                            <dt><a target="_blank"  href="/sdkDownload">SDK下载</a></dt>
                        </dl>
                    </div>
                </div>
            </div>
            ...
            <div class="menu-login-btn h4">
                <a target="_blank" class="h5" href="/register">注册</a>
                / <a target="_blank" class="h5" href="/index">登录</a>
                <p class="header-menu-borderP">
                </p>
            </div>
        </div>
            ...
            <ul class="nav navbar-nav">
                <li class="dropdown">
                    ...
                    <ul class="dropdown-menu">
                        ...
                        <!--<li><a  href="/officialPay">公众号支付</a></li>-->
                ...
                <li class="dropdown">
                    ...
                    <ul class="dropdown-menu">
                        <li>API文档</li>
                        <li><a ui-sref="webPay">PC网页支付</a></li>
                        <li><a ui-sref="mchScan">扫码支付</a></li>
                        <li><a ui-sref="h5Pay">H5支付</a></li>
                        <li>SDK下载</li>
                ...
                <li><a href="html/coop/coopCompApp.html">合作案例</a></li>
                <li><a href="html/help/helpBase.html">帮助</a></li>
                <li><a target="_blank" class="h5" href="/register">注册</a></li>
                <li><a target="_blank" class="h5" href="/index">登录</a></li>
            </ul>
        </div>
    </div>
</div>
