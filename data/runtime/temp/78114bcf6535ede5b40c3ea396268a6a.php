<?php if (!defined('THINK_PATH')) exit(); /*a:3:{s:83:"D:\phpStudy\PHPTutorial\WWW\mofee\public/../data/template/index/index\phonePay.html";i:1521307781;s:78:"D:\phpStudy\PHPTutorial\WWW\mofee\data\template\index\common\product-head.html";i:1521339463;s:76:"D:\phpStudy\PHPTutorial\WWW\mofee\data\template\index\common\index-foot.html";i:1521339555;}*/ ?>
    <!DOCTYPE html>
...
<div ui-view="" class="outer-content ng-scope" id="main_content" style="">
    <div class="container-fluid padding-none pay-box-wrap ng-scope">
        ...
        <div class="container">
            <div class="product-type product-type-white product-type3">
                <h3 class="clearfix"><i class="pull-left"></i><span class="pull-left">手机网页支付</span></h3>
                <div class="product-type-txt">
                    <p>不依赖App等媒介，手机网页也可以拥有多种支付方式</p>
                    <p>H5网页、微商都可以使用。</p>
                </div>
            </div>
            <img src="/static/ipay/images/banner-right2.png" class="pay-top-right phone-pay-top-right">
        </div>
    </div>
    <div class="bgf">
        <div class="container">
            <div class="row">
                ...
                <div class="joinmode-item col-md-12 text-center">
                    ...
                    <div class="fifth-contet-btn">
                        <a class="btn btn-black btn-red" ui-sref="h5Pay" target="_blank" ng-btn-hover="" href="/support/doc">查看API文档</a>
