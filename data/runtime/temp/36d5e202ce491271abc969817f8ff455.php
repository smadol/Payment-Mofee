<?php if (!defined('THINK_PATH')) exit(); /*a:2:{s:80:"D:\phpStudy\PHPTutorial\WWW\mofee\public/../data/template/index/support\sdk.html";i:1521310276;s:78:"D:\phpStudy\PHPTutorial\WWW\mofee\data\template\index\common\product-head.html";i:1521339463;}*/ ?>
    <!DOCTYPE html>
        ...
        <div class="row">
            <div class="col-md-4 col-sm-6 col-xs-12">
                <div class="thumbnail sdk-type  sdk-type2">
                    ...
                    <div class="caption">
                        <p><a target="_blank" href="https://github.com/iPaynow/ipaynowClientDemo.git">聚合SDK下载</a></p>
                        <!--<p><a href="">跨境支付SDK下载</a></p>-->
                    </div>
                </div>
            </div>
            <div class="col-md-4 col-sm-6 col-xs-12">
            ...
            <div class="col-md-4 col-sm-6 col-xs-12">
                <div class="thumbnail sdk-type sdk-type3">
                    ...
                    <div class="caption">
                        <p><a target="_blank" href="https://github.com/iPaynow/iPaynowDomesticServerSDK.git">服务端SDK下载</a></p>
                    </div>
                </div>
            </div>
        </div>
